...
def verify():
    ...
    if request.method == 'POST':
        ...
        if (account):
            ...
            msg = Message(subject='OTP', sender='JobMen@gmail.com',
                          recipients=[session['regmail']])
            msg.body = "You have succesfully registered for Job Men!\nUse the OTP given below to verify your email ID.\n\t\t" + \
                str(otp)
            mail.send(msg)
...
def ForgotPassword():
    ...
    if request.method == 'POST':
        ...
        if i == 1:
            if otp == int(user_otp):
                i = 2
                return render_template('ForgotPassword.html', i=i)
            else:
                return render_template('ForgotPassword.html', msg="OTP is invalid. Please enter a valid OTP", i=i)
            ...
            if (account):
                ...
                return render_template('ForgotPassword.html', msg="It looks like you are not yet our member!")
    i = 0
